...
async function seed() {
    try {
        ...
        const adminVendor = await Vendor.create({
            userId: admin._id,
        ...
        // MAIN CATEGORIES
        const eyewearMain = await Category.create({
            name: 'Eyeglasses',
            slug: 'eyeglasses',
            level: 'main',
        ...
        const sunglassesMain = await Category.create({
            name: 'Sunglasses',
            slug: 'sunglasses',
            level: 'main',
        ...
        const contactLensesMain = await Category.create({
            name: 'Contact Lenses',
            slug: 'contact-lenses',
            level: 'main',
        ...
        const accessoriesMain = await Category.create({
            name: 'Accessories',
            slug: 'accessories',
            level: 'main',
        ...
        const eyeglassesMen = await Category.create({
            name: 'Men',
            slug: 'men-eyeglasses',
            level: 'sub',
        ...
        const eyeglassesWomen = await Category.create({
            name: 'Women',
        ...
        const eyeglassesKids = await Category.create({
            name: 'Kids',
        ...
        const sunglassesMen = await Category.create({
            name: 'Men',
            slug: 'men-sunglasses',
            level: 'sub',
        ...
        const sunglassesWomen = await Category.create({
            name: 'Women',
        ...
        const sunglassesKids = await Category.create({
            name: 'Kids',
        ...
        const sportsSunglasses = await Category.create({
            name: 'Sports',
        ...
        // Men
        const prescriptionMen = await Category.create({
        ...
        const zeroPowerMen = await Category.create({
        ...
        const computerGlassesMen = await Category.create({
        ...
        const readingMen = await Category.create({
        ...
        // Women
        const prescriptionWomen = await Category.create({
            name: 'Prescription Glasses',
        ...
        const zeroPowerWomen = await Category.create({
            name: 'Zero Power (Fashion)',
        ...
        const computerWomen = await Category.create({
        ...
        const readingWomen = await Category.create({
            name: 'Reading Glasses',
        ...
        // Men Sunglasses
        const normalMen = await Category.create({
        ...
        const polarizedMen = await Category.create({
        ...
        const uvProtectionMen = await Category.create({
            name: 'UV Protection',
        ...
        const sportsMen = await Category.create({
        ...
        const drivingMen = await Category.create({
        ...
        // Women Sunglasses
        const normalWomen = await Category.create({
            name: 'Normal Sunglasses',
        ...
        const polarizedWomen = await Category.create({
            name: 'Polarized Sunglasses',
        ...
        const uvProtectionWomen = await Category.create({
            name: 'UV Protection',
        ...
        const sportsWomen = await Category.create({
            name: 'Sports Sunglasses',
        ...
        const fashionWomen = await Category.create({
        ...
        // Kids Sunglasses
        const normalKids = await Category.create({
            name: 'Normal Sunglasses',
        ...
        const uvProtectionKids = await Category.create({
            name: 'UV Protection',
        ...
        const sportsKids = await Category.create({
            name: 'Sports Sunglasses',
        ...
        const dailyDisposable = await Category.create({
        ...
        const monthlyDisposable = await Category.create({
        ...
        const solutionsCare = await Category.create({
            name: 'Solutions & Care',
            slug: 'solutions-care',
            level: 'sub',
            parentId: contactLensesMain._id
        ...
        // Daily Disposable
        const dailyClear = await Category.create({
            name: 'Clear Lenses',
        ...
        const dailyColored = await Category.create({
            name: 'Colored Lenses',
        ...
        // Monthly Disposable
        const monthlyClear = await Category.create({
            name: 'Clear Lenses',
        ...
        const monthlyColored = await Category.create({
            name: 'Colored Lenses',
        ...
        const monthlyToric = await Category.create({
        ...
        // Solutions & Care
        const lensSolutions = await Category.create({
            name: 'Lens Solutions',
            slug: 'lens-solutions',
            level: 'subsub',
        ...
        const eyeDrops = await Category.create({
            name: 'Eye Drops',
            slug: 'eye-drops',
            level: 'subsub',
            parentId: solutionsCare._id
        ...
        const lensCases = await Category.create({
            name: 'Lens Cases',
            slug: 'lens-cases',
            level: 'subsub',
            parentId: solutionsCare._id
        ...
        const eyewearCases = await Category.create({
            name: 'Eyewear Cases',
            slug: 'eyewear-cases',
            level: 'sub',
        ...
        const cleaningKits = await Category.create({
            name: 'Cleaning Kits',
            slug: 'cleaning-kits',
            level: 'sub',
            parentId: accessoriesMain._id
        ...
        const chainsStraps = await Category.create({
            name: 'Chains & Straps',
            slug: 'chains-straps',
            level: 'sub',
            parentId: accessoriesMain._id
        ...
        // Eyewear Cases
        const hardCases = await Category.create({
            name: 'Hard Cases',
            slug: 'hard-cases',
            level: 'subsub',
        ...
        const softPouches = await Category.create({
            name: 'Soft Pouches',
            slug: 'soft-pouches',
            level: 'subsub',
            parentId: eyewearCases._id
        ...
        // Cleaning Kits
        const sprayKits = await Category.create({
        ...
        const microfiber = await Category.create({
        ...
        // Chains & Straps
        const metalChains = await Category.create({
            name: 'Metal Chains',
            slug: 'metal-chains',
            level: 'subsub',
        ...
        const beadedChains = await Category.create({
            name: 'Beaded Chains',
            slug: 'beaded-chains',
            level: 'subsub',
            parentId: chainsStraps._id
